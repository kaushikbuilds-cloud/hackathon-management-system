...
export function ActivateForm() {
  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <TextField label="Participant ID" name="participant_code" required maxLength={30} placeholder="PRT-2026-0001" defaultValue={state.participantCode} autoComplete="username" autoCapitalize="characters" />
