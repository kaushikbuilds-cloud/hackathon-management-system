...
export function ActivateForm() {
  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <TextField label="Team ID" name="team_code" required maxLength={30} placeholder="e.g. SAMPLE1-T0001" hint="Printed on every member's ID card. One login for the whole team." defaultValue={state.teamCode} autoComplete="username" autoCapitalize="characters" />
